...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        $rule = array(
            'title'=> array('.list-group-item>a','text'),
            'url'=> array('.list-group-item>a','href')
        );

        $rang = ".list-group>li";

        $data =  QueryList::Query($page,$rule);

        $content_rule = array(
            'content' => array('#emojify','html')
        );
//        var_dump($data);
        $article = array();
...
//           var_dump($post);
           $url = $post['url'];
           $content =  QueryList::Query($url,$content_rule);
